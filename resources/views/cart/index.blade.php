      ...
      <table class="w-full text-sm md:text-base" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="justify-end md:flex md:mt-6">
            <div class="w-20 h-10">
            ...
            <div class="justify-center md:flex">
              <form action="{{ route('cart.store.coupon') }}" method="POST">
                  ...
                  <div class="flex items-center w-full h-12 pl-3 bg-white bg-gray-100 border rounded-full">
                    <input type="coupon" name="code" id="coupon" placeholder="Apply coupon" value="{{ $coupon->code ?? '' }}"
              ...
              @else
              <h1 class="mt-4 text-xl text-center text-green-500">A coupon is applied</h1>
              @endif
          </div>
            ...
            <div class="mt-4">
              ...
              @if (request()->session()->has('coupon'))
                <div class="flex justify-between pt-4 border-b">
                  <div class="flex items-center px-4 py-2 m-2 text-xl font-bold text-center text-gray-800">
                  ...
                  <div class="px-4 py-2 m-2 text-lg font-bold text-center text-green-700">
                    -{{ getPrice(request()->session()->get('coupon')['discount']) }}
                  </div>
                </div>
                <div class="flex justify-between pt-4 border-b">
                  <div class="px-4 py-2 m-2 text-xl font-bold text-center text-gray-800">
                  ...
                  <div class="px-4 py-2 m-2 text-lg font-bold text-center text-gray-900">
                    {{ getPrice($coupon->couponSubtotal()) }}
                  </div>
                </div>
                <div class="flex justify-between pt-4 border-b">
                  <div class="px-4 py-2 m-2 text-xl font-bold text-center text-gray-800">
