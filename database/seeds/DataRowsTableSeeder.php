...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($productDataType, 'subtitle');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($categorieDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Name',
        ...
        $dataRow = $this->dataRow($categorieDataType, 'slug');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Slug',
        ...
        $dataRow = $this->dataRow($orderDataType, 'payment_intent_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
        ...
        $dataRow = $this->dataRow($orderDataType, 'amount');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'number',
                'display_name' => 'Amount',
        ...
        $dataRow = $this->dataRow($orderDataType, 'payment_created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'Payment Created At',
                'required'     => 1,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $dataRow = $this->dataRow($orderDataType, 'products');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
